...
##Switches
## Remember to unset these. As they are currently utilized for PWM debugging.
...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { DBG_SWITCH }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
